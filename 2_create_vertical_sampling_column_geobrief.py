...
output_dir = "C:/Users/cijzendoornvan/OneDrive - Delft University of Technology/Documents/DuneForce/Publications/Geobrief/"
...
for date in dates:
    ...
    for i, loc in enumerate(locations):
        ...
        norm  = colors.Normalize(vmin=250, vmax=350)
        ...
        cax = fig.add_axes([0.08, 0.045, 0.56, 0.05])
        fig.colorbar(scalarMap, cax=cax, orientation='horizontal')
